...
dataFrame = pd.DataFrame(data, index = range(20), columns = range(20))
npDataFrame = np.array(dataFrame)
...
for row in range(20):
    for col in range(16):
        product = 1
        for z in range(4):
            product *= npDataFrame[row][col+z]
        if product > horizontalMax:
            horizontalMax = product
            horizontalMaxList = [npDataFrame[row][col+z] for z in range(4)]
print("horizontal: ", horizontalMaxList, "=", horizontalMax)
...
for row in range(16):
    for col in range(20):
        product = 1
        for z in range(4):
            product *= npDataFrame[row+z][col]
        if product > verticalMax:
            verticalMax = product
            verticalMaxList = [npDataFrame[row+z][col] for z in range(4)]
print("vertical: ", verticalMaxList, "=", verticalMax)
...
for row in range(16):
    for col in range(16):
        product = 1
        for z in range(4):
            product *= npDataFrame[row+z][col+z]
        if product > diagonalMax:
            diagonalMax = product
            diagonalMaxList = [npDataFrame[row+z][col+z] for z in range(4)]
for row in range(4,20):
    for col in range(16):
        ...
        if product > diagonalMax:
            diagonalMax = product
            diagonalMaxList = [npDataFrame[row-z][col+z] for z in range(4)]
print("diagonal: ", diagonalMaxList, "=", diagonalMax)
print("max: ", max(horizontalMax,verticalMax,diagonalMax))