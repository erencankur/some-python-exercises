...
def create_database():
    if os.path.exists("Python101/Py_Machine_Learning/py_with_sql.db"):
        os.remove("Python101/Py_Machine_Learning/py_with_sql.db")

    conn = sqlite3.connect("Python101/Py_Machine_Learning/py_with_sql.db")
    cursor = conn.cursor()
...
def insert_sample_data(cursor):
    ...
    # cursor.executemany('''
    #     INSERT INTO Students (id, name, age, email, city) VALUES (?, ?, ?, ?, ?)
    # ''', students)
...
def questions():
    '''
    Basit
    1) Bütün kurslarin bilgilerini getirin
    2) Sadece eğitmenlerin ismini ve ders ismi bilgilerini getirin
    3) Sadece 21 yaşindaki öğrencileri getirin
    4) Sadece Chicago'da yaşayan öğrencileri getirin
    5) Sadece 'Dr. Anderson' tarafindan verilen dersleri getirin
    ...
    2) 20 yaşindan büyük öğrencileri, ismine göre siralayarak getirin
...
def answers(cursor):
    ...
    # Basit
    print("1. Bütün kurslarin bilgilerini getirin")
    ...
    print("3. Sadece 21 yaşindaki öğrencileri getirin")
    ...
    print("5. Sadece 'Dr. Anderson' tarafindan verilen dersleri getirin")
    ...
    print("2. 20 yaşindan büyük öğrencileri, ismine göre siralayarak getirin")
